...
import com.softwaremill.supler_example.SuplerExampleServletSpec
import com.softwaremill.supler_example.dao.user.InMemoryUserDao
...
class UsersServletSpec extends SuplerExampleServletSpec {
