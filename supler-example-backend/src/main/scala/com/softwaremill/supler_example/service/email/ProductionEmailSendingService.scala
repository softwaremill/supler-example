...
import com.softwaremill.supler_example.service.email.sender.{EmailSender, EmailDescription}
import com.softwaremill.supler_example.service.config.EmailConfig
